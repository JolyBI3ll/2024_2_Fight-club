...
type MockServiceSession struct {
	...
	MockCreateSession  func(ctx context.Context, user *domain.User) (*sessions.Session, error)
...
func (m *MockServiceSession) CreateSession(ctx context.Context, user *domain.User) (*sessions.Session, error) {
