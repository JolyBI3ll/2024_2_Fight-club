...
var file_ads_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x67, 0x65, 0x73, 0x22, 0x49, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x41,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0xb2, 0x01, 0x0a,
	...
	0x74, 0x68, 0x44, 0x61, 0x74, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x67, 0x75, 0x65, 0x73, 0x74, 0x43,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x67, 0x75, 0x65, 0x73,
	0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x72, 0x61, 0x74, 0x69, 0x6e,
	0x67, 0x32, 0x80, 0x04, 0x0a, 0x03, 0x41, 0x64, 0x73, 0x12, 0x40, 0x0a, 0x0c, 0x47, 0x65, 0x74,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x32, 0x5a, 0x30, 0x2e, 0x2e, 0x2f, 0x6d, 0x69, 0x63, 0x72, 0x6f,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x61, 0x64, 0x73, 0x5f, 0x73, 0x65, 0x72,
...
func file_ads_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ads_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeleteAdImageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ads_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPlacesPerCityRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ads_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserPlacesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ads_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllAdsResponseList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ads_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ads_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ads_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ads_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ads_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
	...
	file_ads_proto_msgTypes[14].OneofWrappers = []interface{}{}
	type x struct{}
