...
var Places = []Place{
	{
		ID: 1, LocationMain: "Россия, Москва", LocationStreet: "Тверская ул, 21к2", Position: []float64{55.7558, 37.6173},
	...
	{
		ID: 2, LocationMain: "Россия, Санкт-Петербург", LocationStreet: "Невский проспект, 6А", Position: []float64{59.9311, 30.3609},
	...
	{
		ID: 3, LocationMain: "Россия, Казань", LocationStreet: "Улица Баумана, 22/1", Position: []float64{55.7894, 49.1221},
	...
	{
		ID: 4, LocationMain: "Россия, Новосибирск", LocationStreet: "Красный проспект, 43к1", Position: []float64{55.0415, 82.9346},
	...
	{
		ID: 5, LocationMain: "Россия, Екатеринбург", LocationStreet: "Проспект Ленина, 21к2", Position: []float64{56.8389, 60.6057},
	...
	{
		ID: 6, LocationMain: "Россия, Нижний Новгород", LocationStreet: "Большая Покровская ул., 2к1", Position: []float64{56.3287, 44.0020},
	...
	{
		ID: 7, LocationMain: "Россия, Красноярск", LocationStreet: "Проспект Мира, 15А", Position: []float64{56.0153, 92.8932},
	...
	{
		ID: 8, LocationMain: "Россия, Владивосток", LocationStreet: "Светланская ул., 1к1", Position: []float64{43.1155, 131.8855},
	...
	{
		ID: 9, LocationMain: "Россия, Ростов-на-Дону", LocationStreet: "Большая Садовая ул, 9М", Position: []float64{47.2357, 39.7015},
	...
	{
		ID: 10, LocationMain: "Россия, Самара", LocationStreet: "Улица Куйбышева, 19к1", Position: []float64{53.1959, 50.1002},
	...
	{
		ID: 11, LocationMain: "Россия, Омск", LocationStreet: "Улица Ленина, 11Б", Position: []float64{54.9885, 73.3242},
	...
	{
		ID: 12, LocationMain: "Россия, Волгоград", LocationStreet: "Проспект Ленина, 44к6", Position: []float64{48.7080, 44.5133},
	...
	{
		ID: 13, LocationMain: "Россия, Воронеж", LocationStreet: "Проспект Революции, 7Ак1", Position: []float64{51.6720, 39.1843},
	...
	{
		ID: 14, LocationMain: "Россия, Краснодар", LocationStreet: "Улица Красная, 9к2", Position: []float64{45.0355, 38.9753},
	...
	{
		ID: 15, LocationMain: "Россия, Уфа", LocationStreet: "Улица Ленина, 88Б", Position: []float64{54.7388, 55.9721},
	...
	{
		ID: 16, LocationMain: "Россия, Ярославль", LocationStreet: "Проспект Ленина, 66А", Position: []float64{57.6260, 39.8845},
	...
	{
		ID: 17, LocationMain: "Россия, Тюмень", LocationStreet: "Площадь Ленина, 13к1", Position: []float64{57.1530, 65.5343},
	...
	{
		ID: 18, LocationMain: "Россия, Тула", LocationStreet: "Проспект Ленина, 44Бк2", Position: []float64{54.1920, 37.6156},
	...
	{
		ID: 19, LocationMain: "Россия, Ижевск", LocationStreet: "Улица Ленина, 14к4", Position: []float64{56.8526, 53.2048},
	...
	{
		ID: 20, LocationMain: "Россия, Челябинск", LocationStreet: "Проспект Ленина, 15к2", Position: []float64{55.1599, 61.4026},
